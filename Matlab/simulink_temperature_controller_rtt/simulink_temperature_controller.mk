...
# Autogenerated on: 24-Nov-2016 16:20:11
# Model: SIMULINK_TEMPERATURE_CONTROLLER
# MyTemplate
# File name: simulink_temperature_controller.mk
# Template: gmake 
...
MODEL_NAME := simulink_temperature_controller
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/include" -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"C:/workspaces/arduino/temperature_PID/Matlab/simulink_temperature_controller_rtt" -I"C:/workspaces/arduino/temperature_PID/Matlab" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/extern/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/simulink/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/ert" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/variants/standard" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/libraries/Servo" -mmcu=atmega328p -ffunction-sections -fdata-sections -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"_RTT_USE_SERIAL0_=" -D"MODEL=simulink_temperature_controller" -D"NUMST=3" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=1" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"F_CPU=16000000" -D"ARDUINO=105" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_RTT_NUMSERVOS_=0"
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  simulink_temperature_controller.hex
